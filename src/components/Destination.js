...
function Destination() {
    return (
      ...
      text = "if you're looking for a hike that's a little more challenging but still good for a befinner mountaineer, check out Mt.Daguldul in San Juan, Batangas. You'll start your hike from the beach and pass through tropical forest, different rock formations, and small streams. There's a small store halfway up the trail where you can take a break and drink buko juice, and though the summit itself may not have the best view, the breeze is fantastic. Once you've made it back down, head straigh to the beach fot a refreshing, well-deserved swim."
      img1 = {Mountain3}
      img2 = {Mountain4}
      />
